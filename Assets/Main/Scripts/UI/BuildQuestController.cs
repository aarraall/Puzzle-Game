...
namespace Main.Scripts.UI
{
    public class BuildQuestController : QuestController<BuildQuestData>
    {
        ...
        {
            base.StartQuest();
            GameManager.Instance.EventHandler.Subscribe(GameEvent.OnCreateItem, OnMerge);
        }
        ...
        private void OnDestroy()
        {
            ...
            GameManager.Instance.EventHandler.Unsubscribe(GameEvent.OnCreateItem, OnMerge);
        }
